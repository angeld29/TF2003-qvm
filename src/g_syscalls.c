...
gedict_t* trap_find( gedict_t* ent,intptr_t fofs, const char*str )
{
...
void trap_infokey( intptr_t edn, const char *key, char *valbuff, intptr_t sizebuff )
{
...
void trap_WriteString( intptr_t to, const char *data )
{
